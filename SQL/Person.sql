 ...
 *  1: insert OK
 */
CREATE FUNCTION insertPerson (p_person_id INT, p_first_name VARCHAR(32), 
p_last_name VARCHAR(32), p_sex VARCHAR(1), p_dob DATE,
p_street1 VARCHAR(45), p_street2 VARCHAR(45), p_city VARCHAR(45),
p_state_id INT, p_zip VARCHAR(5)) RETURNS INT
BEGIN
...
BEGIN
    SELECT staff_no,
           ...
           first_name,
           position
      FROM person INNER JOIN staff USING (person_id)
    ORDER BY last_name ASC;
END $$
/*
